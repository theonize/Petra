...
|---|---|---|
| Set fixed (team deadline) | Song Selector publishes titles; Worship Lead publishes keys, tempos, forms, charts | Open the plan; flag range or capo trouble **now** |
...
**Band** — chart learned and downloaded (or confirmed on confidence); patches/scenes per song; capo and instrument changes planned; know motif vs pad vs groove per section; gear working, backups for critical items; tablet charged. Drummers: lock tempo/feel with the Worship Lead and any tracks before debating fills.
...
**Both** — rehearsal on the calendar; conflicts flagged early; if something is not ready, tell the Worship Lead **before** the ready-to-rehearse time so the plan can be simplified.

## In the room

- Talk between songs, not over the Worship Lead; tune quietly; fix buzzes without a TED talk
