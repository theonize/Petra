...
Rehearsal is for **ensemble** problems — blend, transitions, tech, and feel — not for first exposure to the songs.
...
**No prior rehearsal → default is you do not serve that service.**

Accepting a schedule is accepting the rehearsal that belongs to it. Pre-service run-through is a confirmation pass, not a makeup rehearsal.
...
Details: [Lyrics & Stage Displays](../05-tech/lyrics-and-stage-displays.md).
...
Use the simple role-by-role guide in [Midweek Rehearsal Runbook](midweek-rehearsal-runbook.md). Local teams fill in both a **present-by** time and a later **ready-to-rehearse** time; readiness, not merely entering the building, is the standard.

## Stage reading default

Default staging is **confidence monitors** (also called video monitors) for lyrics/cues and charts where provided, rather than music stands. Stands are exception-only — see [Lyrics & Stage Displays](../05-tech/lyrics-and-stage-displays.md).
...
- [Midweek Rehearsal Runbook](midweek-rehearsal-runbook.md)
- [Pre-Service Rehearsal](pre-service-rehearsal.md)
- [Scheduling Policy](../02-scheduling/scheduling-policy.md)
- [Lyrics & Stage Displays](../05-tech/lyrics-and-stage-displays.md)
