...
| FOH / Monitors | Correct show file ready; inputs, talkback, RF, and monitor plan prepared |
...
- Stabilize gains early
- **Media:** run **overhead (house) and confidence** for the working set — same deck mindset as Sunday
...
|---|---|
| House / overhead | On and advanced with the set |
| Confidence monitors | On; band/vocals use them (stands only if already excepted) |
| Stream | As needed for training / critical weekends |

Do not “save the real slides for Sunday.” Rehearsal is where timing and form bugs die.
...
- keys, tempos, forms, tags, and endings
- leads, vocal parts, and arrangement choices
- transitions and spoken/musical cues
- tracks, charts, patches, input needs, and monitor needs
- house lyrics, confidence content, lighting, and stream cues

Before leaving, the Worship Lead and Tech Lead make sure the current plan and affected materials reflect the same agreed version.
...
- [ ] Absences resolved: serve / release / simplify (band **and** tech)
- [ ] Room not trashed
